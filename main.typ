...
- Конструктор класу - конструкція для створення об'єкта типу *Context* який приймає аргументи
...
*Zomboid* - ключевий клас проекту
  - Конструктор - конструкція для створення об'єкта типу *Zomboid* який приймає аргументи
...
*Paginator* - клас який преставляє собою фільтром данних
  - Конструктор класу - конструкція для створення об'єкта типу *Paginator* який приймає аргументи які виступають фільтрами.
...
*PrinterModel* - клас який реалізує вивід у консоль або ж термінал
  - Конструктор класу - контрукція для створення об'єкта типу *PrinterModel* який приймає аргументи
